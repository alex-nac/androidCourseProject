...
public class ButtonFactory {
    ...
    public static Button getTextButton(String backgroundPath, String buttonText, boolean isShaded, float height, float width) {
    ...
    public static Button getImageButton(String backgroundPath, String buttonImagePath, boolean isShaded, float height, float width) {
